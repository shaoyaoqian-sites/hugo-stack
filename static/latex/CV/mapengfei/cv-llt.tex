...
\leftheader{%
  {\LARGE\bfseries\sffamily Pengfei Ma, Ph.D.}

  \makefield{\faEnvelope[regular]}{\href{mailto:mapengfei@mail.nwpu.edu.cn}{\texttt{mapengfei@mail.nwpu.edu.cn}}}
  \makefield{\faGlobe}{\url{https://www.pengfeima.cn/}}

  \makefield{\faTwitter}{\!\href{https://x.com/npuheart}{\texttt{@npuheart}}}
  \makefield{\faWeixin}{\href{https://githubimages.pengfeima.cn/images/202509251124310.jpg}{\texttt{mfmpf1996}}}
  \makefield{\faGithub}{\href{https://github.com/npuheart}{\texttt{npuheart}}}
}
